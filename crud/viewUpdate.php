...
<div class="center-zone-no-limit">
    <form class="form-listing" name="form1" method="post" action="viewUpdate.php">
...
if (isset($_POST['listsalle'])){
    ...
    $stmt = $pdo->prepare("SELECT id_reservation, DateReservation, libelle_heure, libelle_salle, mail,reservation.id_User 
    FROM reservation 
    ...
    $stmt->execute();
            while ($row = $stmt ->fetch()) {
                ...
                echo "<td><a class=\"btn-modif\" href=\"edit.php?id=$row[id_reservation]\">Modifier ma réservation</a></td>";
                echo "---------------";
                echo "</br>";
                echo "</tr>";
                }
